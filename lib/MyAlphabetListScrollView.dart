...
class MyAlphabetListScrollView extends StatefulWidget {
  ...
  const MyAlphabetListScrollView(
      {Key key,
...
class _AlphabetListScrollViewState extends State<MyAlphabetListScrollView> {
  ...
  _initScrollCallback() {
    _pixelUpdates.stream.listen((pixels) {
      ...
      if (tempSelectedIndex != selectedIndex && selectedChar != mapKey) {
        var tempIndex = alphabetList.indexOf(mapKey.toLowerCase());
  ...
  @override
  void didUpdateWidget(MyAlphabetListScrollView oldWidget) {
      ...
      children: <Widget>[
        Center(
          child: Container(
            ...
            child: Padding(
              padding: const EdgeInsets.fromLTRB(24.0, 24.0, 7.0, 24.0),
